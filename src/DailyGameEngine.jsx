                ...
                className={`sudoku-cell ${isWrong ? "bg-red-200" : ""} ${
                  ...
                  ((cell !== null && cell === selectedValue) ||
                   (parseInt(userInput[r][c]) === selectedValue))
                    ? "match-highlight"
                    : ""
                } ${selectedCell && (selectedCell.row === r || selectedCell.col === c) ? "row-col-highlight" : ""}` onFocus={() => setSelectedCell({ row: r, col: c })} onBlur={() => setSelectedCell(null)}}
                type="text"
